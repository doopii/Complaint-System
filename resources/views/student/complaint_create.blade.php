                ...
                <nav class="navbar-center">
                    ...
                    @auth
                        @if(auth()->user()->isStudent())
                            ...
                            <a href="{{ route('complaints.create') }}" class="active">Submit Complaint</a>
                        @elseif(auth()->user()->isAdmin())
                            <a href="{{ route('admin.dashboard') }}">Admin Dashboard</a>
                        @endif
                    @else
                        <a href="{{ route('complaints.dashboard', ['student_id' => $studentId ?? '']) }}">Dashboard</a>
                        <a href="{{ route('complaints.create', ['student_id' => $studentId ?? '']) }}" class="active">Submit Complaint</a>
                    @endauth
                </nav>
            </div>
